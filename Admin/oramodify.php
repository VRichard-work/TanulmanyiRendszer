...
if (isset($_POST['oraid']) && isset($_POST['kezdet']) && isset($_POST['veg']) && isset($_POST['terem']) && isset($_POST['kod']) && isset($_POST['datum'])) {
    $oraid = $_POST['oraid'];
    $kezdet = $_POST['kezdet'];
    $veg = $_POST['veg'];
    $terem = $_POST['terem'];
                    ...
                    <select name="terem" id="terem">
                        ...
                        if ($sql = "SELECT TEREMID FROM TERMEK") {
                            ...
                            while ($rowcount = oci_fetch_array($result)) {
                                $isnul = true;
                                ?>
                                <option value="<?php echo $rowcount['TEREMID']; ?>" <?php if ($rowcount['TEREMID'] == $row['TEREMID']) {
                                       echo ' selected';
                                   } ?>><?php echo $rowcount['TEREMID']; ?></option>
                            <?php }
                            if (!$isnul) { ?>
                    ...
                    <select name="kod" id="kod">
                        ...
                        if ($sql = "SELECT KURZUSID, KNEV FROM KURZUSOK") {
                            ...
                            while ($rowcount = oci_fetch_array($result)) {
                                $isnul = true;
                                ?>
                                <option value="<?php echo $rowcount['KURZUSID']; ?>" <?php if ($rowcount['KURZUSID'] == $row['KURZUSID']) {
                                       echo ' selected';
                                   } ?>>
